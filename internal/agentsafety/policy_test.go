...
func TestDecide(t *testing.T) {
	identified := Identification{
		...
		ProtectedComposeProjects: []string{"docklattice"},
	}
	...
	tests := []struct {
		...
		{"compose down protected", identified, Action{Kind: ActionComposeDown, ComposeProject: "docklattice"}, false, DecisionDenyProtectedProject},
		...
		{"mutation protected project", identified, Action{Kind: ActionMutation, ComposeProject: "docklattice"}, false, DecisionDenyProtectedProject},
